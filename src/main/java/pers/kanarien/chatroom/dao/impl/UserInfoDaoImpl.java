...
public class UserInfoDaoImpl implements UserInfoDao {
    ...
    public void loadUserInfo() {
        // 设置用户基本信息，共9个用户
        UserInfo userInfo = new UserInfo("001", "fanfan", "fan", "static/img/avatar/Member001.jpg");
        UserInfo userInfo2 = new UserInfo("002", "qingqing", "qing", "static/img/avatar/Member002.jpg");
        UserInfo userInfo3 = new UserInfo("003", "longlong", "long", "static/img/avatar/Member003.jpg");
        UserInfo userInfo4 = new UserInfo("004", "dongdong", "dong", "static/img/avatar/Member004.jpg");
        ...
        Constant.userInfoMap.put("fanfan", userInfo);
        Constant.userInfoMap.put("qingqing", userInfo2);
        Constant.userInfoMap.put("longlong", userInfo3);
        Constant.userInfoMap.put("dongdong", userInfo4);
